...
public interface GatewayInterface {
	...
	/**
	 * Retrieves the version and the main informations of the GAL. It can be used
	 * as a way to tell if and when the GAL is running as it does not affect the
	 * status of the GAL and it is a very light command
	 * 
	 * @return
	 * @throws IOException
	 * @throws Exception
	...
	/**
	 * Activation of the discovery procedures of the services of a node connected
	 ...
	 * @throws GatewayException
	 */
	ServiceDescriptor getServiceDescriptorSync(long timeout, Address addrOfInterest, short endpoint)
	...
	/**
	 * Allows the opening of the ZigBee network for all nodes, and for a specified
	 * duration, to be able to associate new nodes
	 * 
	 * @param timeout
	 * 
