...
public interface GatewayConstants {
	 ...
	 * required to manage the APS layer of a device. The attributes of the AIB are
	 * listed in Table 2.24. The security- related AIB attributes are described in
	 * sub-clause 4.4.10.
	 */
	 ...
	 * AliasAddress indicates that the DestinationAddress is an alias address. If
	 * this parameter is omitted then it is assumed that a binding table entry
	 * exists in the GW that determines the destination.
	 */
	public final static short ADDRESS_MODE_GROUP = 1;
