...
/**
 * ZigBee APS Information Base properties
 */
public interface APS_IB_AttrIDs {
	static final short apsDeviceKeyPairSet = 0xaa;
	static final short apsTrustCenterAddress = 0xab;
	static final short apsSecurityTimeoutPeriod = 0xac;
	static final short apsBindingTable = 0xc1;
	static final short apsDesignatedCoordinator = 0xc2;
	static final short apsChannelMask = 0xc3;
	static final short apsUseExtendedPANID = 0xc4;
	static final short apsGroupTable = 0xc5;
	static final short apsNonmemberRadius = 0xc6;
	static final short apsPermissionsConfiguration = 0xc7;
