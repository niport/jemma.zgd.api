...
public class Info implements Serializable {
	...
	@XmlType(name = "", propOrder = { "version", "value", "lqiInformation", "polledMessage", "callbackIdentifier", "callbacks",
			...
			"zdpMessage", "zclCommandResult", "zclMessage", "endpoint", "groups", "bindings", "apsMessageEvent", "apsMessageResult",
			"nodeDescriptor", "powerDescriptor", "userDescriptor", "networkDescriptors", "energyScanResult", "networkStatusCode",
			"nwkMessageEvent", "nwkMessageResult", "interPANMessageEvent", "interPANMessageResult" })
